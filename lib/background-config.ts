 ...
 * - 'blank': Simple black background with no elements
 */

export const BACKGROUND_THEME = 'blank' as const; // Change to test different themes
...
export const BACKGROUND_CONFIG = {
  ...
  blank: {
    name: 'Blank Black',
    description: 'Simple black background with no elements or animations',
