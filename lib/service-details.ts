...
export const serviceDetails: Record<string, ServiceDetail> = {
  "web-development": {
    ...
    whatIs: {
      en: "Web development is creating powerful, scalable, and responsive websites that drive your business forward. We use cutting-edge technologies like Next.js, React, and Node.js to build fast, secure, and user-friendly solutions.",
      ar: "تطوير الويب هو إنشاء مواقع قوية وقابلة للتوسع ومتجاوبة تدفع عملك للأمام. نستخدم أحدث التقنيات مثل Next.js و React و Node.js لبناء حلول سريعة وآمنة.",
    },
    whyNeed: {
      en: [
  ...
  "custom-systems": {
    ...
    slug: "custom-systems",
    whatIs: {
      en: "Custom systems development means building tailored software designed for your business needs. Unlike off-the-shelf software, custom systems match your workflows, integrate with existing tools, and scale with growth.",
      ar: "تطوير الأنظمة المخصصة يعني بناء حلول برمجية مصممة لاحتياجات عملك. الأنظمة المخصصة تتناسب مع سير عملك، تتكامل مع أدواتك، وتتوسع مع نموك.",
    },
    whyNeed: {
      en: [
  ...
  "cybersecurity-solutions": {
    ...
    whatIs: {
      en: "Cybersecurity protects your digital assets, data, and IT infrastructure from cyber threats and malicious attacks. Our solutions combine advanced technologies and proactive monitoring to safeguard your business from ransomware, data breaches, and phishing attacks.",
      ar: "الأمن السيبراني يحمي أصولك الرقمية والبيانات من التهديدات السيبرانية والهجمات الخبيثة. تجمع حلولنا بين التقنيات المتقدمة والمراقبة الاستباقية لحماية عملك من برامج الفدية واختراقات البيانات.",
    },
    whyNeed: {
      en: [
